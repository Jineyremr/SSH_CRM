				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：联系人管理 &gt; <s:property value="#saleVisit==null?'添加':'修改'"/>客户拜访</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								<td>所属客户：</td>
								<td colspan="3"><input type="text" value="<s:property value="#saleVisit.customer.cust_name"/>" id="cust_name" style="WIDTH: 180px"/><input type="hidden" name="customer.cust_id" id="cust_id"/><input type="button" value="选择客户" onclick="window.open('${pageContext.request.contextPath}/CustomerAction_list?select=true','','width=800,height=300')" /></td>
								<td>拜访时间：</td>
								<td>
								<INPUT class=textbox
												style="WIDTH: 180px" maxLength=50 name="visit_time" id="visit_time" readonly="readonly" value="<s:property value="#saleVisit.visit_time"/>">
								</td>
							</tr>
							<TR>
								<td>被拜访人：</td>
							...
							<TR>
								...
								<td>
								<INPUT class=textbox
												style="WIDTH: 180px" maxLength=50 name="visit_nexttime" id="visit_nexttime" readonly="readonly" value="<s:property value="#saleVisit.visit_nexttime" />">
								</td>
							</TR>
							<tr>
								<td rowspan=2>
